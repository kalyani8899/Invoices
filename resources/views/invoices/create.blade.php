                            ...
                            <div class="container">
                                <div class="row clearfix " style="margin-top:20px">
                                    <div class="col-md-3 offset-4 text-center">
                                        ...
                                        Invoice Date:
                                        <br>
                                        <input type="text" name='invoice[invoice_date]' class="form-control" date="{{date('Y-m-d')}}" required>
                                    </div>
                                </div><br>
                                <div class="row clearfix " style="margin-top:20px">
                                    <div class="col-md-12">
                                        ...
                                        Your Company Name
                                        <br>
                                        1 Street Name,Nagpur,India
                                        <br>
                                        Email:kalyaninanhe@gmail.com
                                        <br>
                                        VAT Number:xx xxxx xxx
                                        </div>
                                    </div>
                                </div><br>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <button id='delete_row' class="float-right btn btn-primary">Delete Row</button>
                                    </div>
                                </div>
                                <div class="row clearfix" style="margin-top:20px">
                                    <div class="col-md-12">
                                        <div class="float-right col-md-5">
                                            <table class="table table-bordered table-hover" id="tab_logic_total">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input type="number" id="tax_amount" placeholder='0.00' class="form-control" readonly/></td>
                                                </tr>
                                                <tr>
